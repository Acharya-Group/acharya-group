...
const PaymentNow: React.FC = () => {
  ...
  useEffect(() => {
    if (!orderId) return;
    const found = allOrders.data?.find((o) => o._id === orderId) || null;
    setOrder(found);
    ...
    <div className="container mx-auto px-4 py-10">
      <div className="flex flex-col md:flex-row bg-white shadow-md rounded-xl overflow-hidden">
        ...
        <div className="md:w-1/2 flex items-center justify-center bg-gray-50 p-6">
          <Image unoptimized src="/images/payNow.jpg" alt="Payment" width={400} height={400} className="rounded-lg shadow-md w-full" />
        </div>
      </div>
    </div>
  );
